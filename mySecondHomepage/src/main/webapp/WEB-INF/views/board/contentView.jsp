				...
				<div class="box box-solid box-primary">
					<div class="box-header" align="center">
       				...
       				<div class="box-body container" align="center">
						<div align="left">
							<button type="button" class="btn bg-gray btn-sm btn-flat" onclick="location.href='modify.do?bId=${bDto.BID}'">수정</button> 
							<button type="button" class="btn bg-gray btn-sm btn-flat" onclick="location.href='delete.do?bId=${bDto.BID}&bName=${bDto.BNAME}'">삭제</button>
						</div>
