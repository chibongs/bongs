								...
								<tr>
									<th>
										<textarea class="textarea" name="bTitle" placeholder="제목을 작성해 주십시오."
                          				style="width: 100%; height: 40px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">${bdto.BTITLE}</textarea>
									</th>
								</tr>
								<tr>
									<td>
									<textarea class="textarea" name="bContent" placeholder="내용을 작성해 주십시오."
                          				style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">${bdto.BCONTENT}</textarea>
									</td>							
								</tr>
							</table>
						</form>
						<div align="left">
							<button type="button" class="btn btn-link btn-flat" onclick="location.href='boardList.do?GMId=${bdto.BNAME}'">뒤로</button>
						</div>
      		 		</div>		
				</div>	
			</section>
